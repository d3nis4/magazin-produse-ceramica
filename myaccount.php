...
<head><!DOCTYPE html>
    ...
    <meta charset="UFT-8">
            ...
            <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
                ...
                <!-- Link către fișierul JavaScript al Bootstrap-ului (opțional, pentru anumite componente sau funcționalități) -->
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="mt-3">
                                <button type="submit"  name="updateProfileBtn" class="btn btn-primary">Actualizează datele</button>
                                  <a href="my-orders.php" class="btn btn-secondary float-end">Comenzile Mele</a>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p><a href="#" onclick="window.location.href='about.html';">Despre noi</a></p>
            ...
            <div class="col-md-4">
                <h4>Contul meu</h4>
                <p><a href="login.html" target="_blank">Conecteaza-te</a></p>
